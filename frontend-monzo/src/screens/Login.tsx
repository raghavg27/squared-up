  ...
  return (
    <div className="min-h-screen flex flex-col px-mobile bg-paper">
      <div className="flex-1 flex flex-col items-center justify-center">
        <Logo />
        <h1 className="font-heading text-[34px] leading-tight font-extrabold text-ink mt-6">Squared Up</h1>
        ...
        {step === 'intro' ? (
          <>
            <button
              ...
              className="w-full max-w-[28rem] bg-primary text-on-primary h-[56px] rounded-full shadow-coral font-heading text-[17px] font-bold flex items-center justify-center gap-2 mt-10 active:scale-[0.98] transition-transform"
            >
            ...
            <div className="w-full max-w-[28rem] flex justify-center">
              {GOOGLE_CLIENT_ID ? (
                ...
                <button onClick={() => setStep('phone')} disabled={busy} className="w-full h-[52px] rounded-full bg-surface-container-lowest shadow-soft flex items-center justify-center gap-2 font-body text-[15px] font-semibold text-ink active:scale-[0.98] transition-transform disabled:opacity-60">
                  <GoogleG /> Google
                </button>
              )}
            </div>
          ...
          <div className="w-full max-w-[28rem] mt-10">
            ...
            <div className="flex items-center gap-2 bg-surface rounded-full shadow-soft px-5 h-[56px] focus-within:outline focus-within:outline-2 focus-within:outline-primary">
            ...
            <button
              onClick={sendOtp}
              disabled={busy}
              className="w-full bg-primary text-on-primary h-[56px] rounded-full shadow-coral font-heading text-[17px] font-bold mt-5 active:scale-[0.98] transition-transform disabled:opacity-60"
            >
