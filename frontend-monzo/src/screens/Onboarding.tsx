  ...
  return (
    <div className="min-h-screen flex flex-col px-mobile bg-paper">
      <div className="flex-1 flex flex-col justify-center">
        ...
        <h1 className="font-heading text-[32px] font-extrabold text-ink mt-5">Welcome!</h1>
      ...
      <div className="pb-8">
        <button
          onClick={finish}
          disabled={busy}
          className="w-full h-[56px] bg-primary text-on-primary rounded-full shadow-coral font-heading text-[17px] font-bold active:scale-[0.98] transition-transform disabled:opacity-60"
        >
