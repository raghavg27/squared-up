  ...
  return (
    <div className="min-h-screen flex flex-col px-mobile bg-paper">
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <h1 className="font-heading text-[28px] font-extrabold text-ink mt-5">Verify your number</h1>
        ...
        <div className="flex gap-2 mt-8" onPaste={onPaste}>
          {digits.map((d, i) => (
            <input
              ...
              inputMode="numeric"
              maxLength={1}
              className="w-12 h-14 text-center font-heading text-[24px] font-extrabold text-ink bg-surface shadow-soft rounded-2xl outline-none focus:outline-2 focus:outline-primary tnum"
            />
          ))}
        </div>
        ...
        <button
          onClick={verify}
          disabled={busy}
          className="w-full max-w-[28rem] bg-primary text-on-primary h-[56px] rounded-full shadow-coral font-heading text-[17px] font-bold mt-8 active:scale-[0.98] transition-transform disabled:opacity-60"
        >
